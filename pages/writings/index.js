                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
                            <div className="sm:w-1/2 relative">
                                ...
                                <img src="https://images.unsplash.com/photo-1617191519105-d07b98b10de6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHNxdWFyZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60" className="w-screen rounded-lg opacity-100 bg-blend-darken" alt="chair" />
                            </div>
                            <div className="sm:w-1/2 sm:mt-0 mt-4 relative bg-gray-900 bg-opacity-50">
                                ...
                                <img src="https://images.unsplash.com/photo-1544296755-7c9f940207ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHByb3Rlc3R8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60" className="w-full rounded-lg  h-80 object-fill" alt="wall design" />
                            </div>
                        </div>
                        
                    </div>
                    
                    <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6  lg:flex flex-col justify-between hidden">
                        ...
                        <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
                            <div className="relative w-full">
                                ...
                                <img src="https://images.unsplash.com/photo-1563900207-a818a616124c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8cmljaHxlbnwwfDJ8MHx8&auto=format&fit=crop&w=900&q=60" className="w-full rounded-lg " alt="chair" />
                            </div>
                            <div className="relative w-full sm:mt-0 mt-4">
                                ...
                                <img src="https://images.unsplash.com/photo-1436397543931-01c4a5162bdb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDV8fG5ldHdvcmt8ZW58MHwyfDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60" className="w-full rounded-lg " alt="wall design" />
                            </div>
                        </div>
                ...
                <div className="lg:flex items-stretch md:mt-8 mt-8">
                    <div className="lg:w-1/2">
                        ...
                        <div className="relative">
                            ...
                            <img src="https://images.unsplash.com/photo-1557098168-47dc193d2c85?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1730&q=80" alt="sitting place" className="w-fill rounded-lg h-fill object-cover mt-8 md:mt-6 hidden sm:block" />
                            <img className="w-full rounded-lg  mt-4 sm:hidden" src="https://images.unsplash.com/photo-1617191519105-d07b98b10de6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHNxdWFyZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60" alt="sitting place" />
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
                        <div className="relative">
                            ...
                            <img src="https://images.unsplash.com/photo-1597589827317-4c6d6e0a90bd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8c3F1YXJlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60" alt="sitting place" className="w-full rounded-lg  sm:block" />
                        </div>
